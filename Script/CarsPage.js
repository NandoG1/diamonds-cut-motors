...
function showSlides(n) {
  let slides = document.getElementsByClassName("main-none");
...
function checkmediax(){
    if(x.matches){
        ...
        document.getElementById("mid-navigation-top").innerHTML = `
            <a href="CarsPage.html" class="big-navigation">CARS PAGE</a>
        `
...
function checkmediay(){
    if(y.matches){
        ...
        `
        document.getElementById("main-top2").innerHTML = "We recommend the very best car"
        ...
        document.getElementById("main-top2").innerHTML = "We recommend the very best car, up to date car, high performance luxury car and friendly price for luxury car"  
